...
public class Windkanal implements UniLocation {
    ...
    private static final String[] Names = {
            "Flugtechnik (Labore)",
            "Flugtechnik (Werkstätten)",
            "Flugtechnik (Windkanal und Halle)",
            "Minimaxoffice",
            "Prüfhalle Hochspannungstrasse (im Bau)",
            "Bürogebäude",
            "Halle",
            "Tower (August-Euler-Informationszentrum)",
            "Halle 1",
            "Halle 2",
            "Halle 3",
            "Douglas DC-8 (August-Euler-Informationszentrum)"
    };

    private static final String[] Addresses = {
            "Flughafenstraße 19, 64347, Griesheim",
            "Flughafenstraße 19, 64347, Griesheim",
            "Flughafenstraße 19, 64347, Griesheim",
            "Flughafenstraße 19, 64347, Griesheim",
            "Flughafenstraße, 64347, Griesheim",
            "Flughafenstraße 15, 64347, Griesheim",
            "Flughafenstraße 15, 64347, Griesheim",
            "August-Euler-Flugplatz 7, 64347, Darmstadt",
            "August-Euler-Flugplatz 19, 64347, Darmstadt",
            "August-Euler-Flugplatz 9, 64347, Darmstadt",
            "August-Euler-Flugplatz 11, 64347, Darmstadt",
            "August-Euler-Flugplatz 1, 64347, Darmstadt"
    };
